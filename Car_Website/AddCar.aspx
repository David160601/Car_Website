...
<asp:Content ContentPlaceHolderID="AdminMasterPagePlaceHolder" Runat="Server">
    <div>
        ...
        <div style="margin-top:16px">
           <asp:CheckBox runat="server" ID="chkAgree" Text="Checked mean that you have agreed to our terms and policy." OnCheckedChanged="chkAgree_Checked"   AutoPostBack="True" />
        </div>
        <div style="margin-top:16px">
